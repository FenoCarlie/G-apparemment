                ...
                <div className="bg-[#ffffff] w-[70%] rounded-xl">
                    <header className="mt-6 flex items-center justify-between flex-wrap p-4">
                        ...
                        <div className="text-sm lg:flex-grow flex justify-end">
                            ...
                            <button data-modal-target="default-modal" data-modal-toggle="default-modal" className="ml-5 cursor-pointer group relative items-center flex gap-1.5 px-8 py-4 bg-black bg-opacity-80 text-[#f1f1f1] rounded-2xl hover:bg-opacity-70 transition font-semibold shadow-md">
                                <MdAddHomeWork
                                    style={{
                                        width: "24px",
                                        height: "24px",
