                ...
                <div className="bg-[#ffffff] w-[70%] rounded-xl">
                    ...
                    <div className="mt-6">
                        <div className="relative overflow-x-auto">
                            ...
                            <div className="flex items-center justify-end flex-wrap py-2 px-6">
                                <div className="flex items-center flex-shrink-0 mr-6">
                                    nombre de page
                                </div>
                                <div className="text-sm lg:flex-grow flex justify-end">
                                    <button className="ml-2 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-l">
                                        Prev
                                    </button>
